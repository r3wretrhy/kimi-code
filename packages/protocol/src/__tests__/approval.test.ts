/**
 * Approval entity + REST schema tests (SCHEMAS.md §6.1 / REST.md §3.6,
 * W8.1 / Chain 5).
 */
...
describe('approvalRequestSchema (SCHEMAS §6.1)', () => {
  ...
  it('accepts arbitrary tool_input_display shapes (12-arm passthrough)', () => {
    // SCHEMAS §6.1 mandates passthrough — unknown kinds must NOT be rejected.
...
describe('approvalResolveRequestSchema (REST §3.6)', () => {
  it('aliases approvalResponseSchema', () => {
    // Body is the response payload — symmetry check via shared parse.
